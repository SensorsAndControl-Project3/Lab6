...
Base2EndEffectorTrans = leftImageEndEffectorPose(1:3,4)';
Base2EndEffector = [Base2EndEffectorTrans;Base2EndEffectorTrans;Base2EndEffectorTrans;Base2EndEffectorTrans]

EndEffector2CameraTrans = [-0.022,0.000,0.055];
EndEffector2Camera = [EndEffector2CameraTrans;EndEffector2CameraTrans;EndEffector2CameraTrans;EndEffector2CameraTrans]
...
Dobot(Coordinates, PumpOperation);
...
function Dobot(Coordinates, PumpOperation)
